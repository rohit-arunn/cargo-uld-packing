...
def create_box(x, y, z, dx, dy, dz, color, opacity=1.0, name=""):
    ...
    All the functios for edges below which are followed by the 
    functions for the respective ULDs
...
def create_ld8_edges(vertices, line_color='black', line_width=2):
    # Define edge pairs (12 for a cube, more for complex shapes)
    edges = [
        (0, 1), (1, 2), (2, 3), (3, 0),  # bottom face
        (4, 5), (5, 6), (6, 7), (7, 4),  # top face
...
def create_ld9_edges(vertices, line_color='black', line_width=2):
    # Define edge pairs (12 for a cube, more for complex shapes)
    edges = [
        (0, 1), (1, 2), (2, 3), (3, 0),  # bottom face
        (4, 5), (5, 6), (6, 7), (7, 4),  # top face 
...
def create_ld1(color = "blue", origin=(0, 0, 0), opacity=0.15, name=""):
...
def create_ld3(color = "blue", origin=(0, 0, 0), opacity=0.15, name=""):
    # Returns a Mesh3d representing a box
    x, y, z = origin
    vertices = [
        [x,     y,     z],
...
def create_ld8(color = "blue", origin=(0, 0, 0), opacity=0.3, name=""):
    # Returns a Mesh3d representing a box
    x, y, z = origin
    vertices = [
        [x+14.5,     y,     z],
    ...
    edges = create_ld8_edges(vertices)
    return mesh, edges

def create_ld9(color = "blue", origin=(0, 0, 0), opacity=0.3, name=""):
    ...
    edges = create_ld9_edges(vertices)
    return mesh, edges
