...
from packing import is_box_inside_ld9, is_point_inside_ld9
...
def is_supported_in_ld9(x, y, z, dx, dy, dz, grid, threshold=0.7, give_ratio = False):
    if z == 0:
...
def ld9_checker(x, y, z, dx, dy, dz, grid, threshold = 0.9):
    return (
        is_box_inside_ld9(x, y, z, dx, dy, dz)
        and is_supported_in_ld9(x, y, z, dx, dy, dz, grid, threshold)
    )
...
#                                 is_box_inside_ld9(x, y, z, dx, dy, dz) and
#                                 is_supported_in_ld9(x, y, z, dx, dy, dz, grid, threshold=0.9)
#                                     ):
